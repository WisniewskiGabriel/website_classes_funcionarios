...
export function getRandomAge(){                                                        //gera uma idade aleatória de 1 a 99
...
export function getRandomName(){                                                       //... apenas
    return getRandomFromList(name_list);                                        //...
}                                                                               //... pegam
                                                                                //...
export function getRandomJob(){                                                        //... valores
    return getRandomFromList(job_list);                                         //...
}                                                                               //... aleatórios
                                                                                //...
export function getRandomDepartment(){                                                 //... a partir
    return getRandomFromList(department_list)                                   //...
}                                                                               //... dos
                                                                                //...
export function getRandomLanguage(){                                                   //... arrays
